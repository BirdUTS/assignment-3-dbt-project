...
-- =============================================================================
-- Datamart: Property Type Analysis
-- =============================================================================
-- Provides insights per property_type, room_type, accommodates, and month/year
-- =============================================================================
...
-- Aggregate by property characteristics and month
current_month AS (
    SELECT
        p.property_type,
        p.room_type,
    ...
    GROUP BY p.property_type, p.room_type, p.accommodates, d.year_month, d.year, d.month
),
